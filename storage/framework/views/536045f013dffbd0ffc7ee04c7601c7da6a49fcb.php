...
<div class="container">
    ...
    <h1 class="display-3 ml-2">Boas Enquetes</h1>
      ...
      <div id="d<?php echo e($question->id); ?>" style="display: block">
          ...
          <?php if($question->id == $answer->idQuestion): ?>
              ...
              <div class="form-check">
                  <input class="form-check-input" type="radio" name="divVotes<?php echo e($question->id); ?>" id="<?php echo e($answer->id); ?>">
          ...
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              <button type="button" class="btn btn-outline-info mt-2"  onclick=" showVote(<?php echo e($question->id); ?>)">Votar</button>
      </div>
...
<?php echo $__env->make('layouts.navDashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\enquetes\resources\views/welcome.blade.php ENDPATH**/ ?>