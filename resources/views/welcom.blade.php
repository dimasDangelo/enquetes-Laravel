      ...
      <div id="d{{$question->id}}" style="display: block">
          ...
          @if($question->id == $answer->idQuestion)
              ...
              <div class="form-check">
                  <input class="form-check-input" type="radio" name="divVotes{{$question->id}}" id="{{$answer->id}}">
          ...
          @endif
          @endforeach
              <button type="button" class="btn btn-outline-info mt-2"  onclick=" showVote({{$question->id}})">Votar</button>
      </div>
